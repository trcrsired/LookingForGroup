...
if EasyMenu then
LookingForGroup.EasyMenu = EasyMenu
else
...
function LookingForGroup.EasyMenu(menuList, menuFrame, anchor, x, y, displayMode, autoHideDelay)
...
LookingForGroup.DropDown = CreateFrame("Frame", nil, UIParent, "UIDropDownMenuTemplate")
